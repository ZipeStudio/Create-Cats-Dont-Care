...
![banner](https://github.com/ZipeStudio/create-cats-dont-care/blob/master/img/showcase.png?raw=true)

**Create: Cats Don't Care** — Lets cats find cozy spots to sit and sleep around your Create factories.

They can:
- Sit on conveyor belts
- Sleep on slow-moving belts
- Relax around your Create factories

More cozy interactions with Create blocks may come in future updates.
...
- Fully synchronized for all players

### Mod Compatibility
- Designed to work naturally with Create modpacks
- Compatible with resource packs and shaders

![showcase](https://github.com/ZipeStudio/create-cats-dont-care/blob/master/img/showcase.gif?raw=true)
...
### [See the original mod repository](https://github.com/ZipeStudio/create-cats-dont-care)